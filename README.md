...
| Part | What | Skip |
|---|---|---|
| Colors | HTB palette forced on tmux, `ls`, and the terminal profile | `--skip-colors` |
| tmux | `0`-indexed, vi keys, 200k history, `\|` `-` splits, shift+drag for native copy, no tab-flicker | `--skip-tmux` |
