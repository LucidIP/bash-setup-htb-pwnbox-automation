#!/bin/bash
# cleanup.sh — removes stale/system tool installs before a fresh provision. Safe to re-run, best-effort.
...
echo "🧹 [8/10] Wordlists, /opt (wipes pivot/tools/hashcat/bloodhound/seclists/PayloadsAllTheThings dirs), Ghidra..."
