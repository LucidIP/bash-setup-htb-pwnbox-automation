...
# (ILSpy, Snyk). Each piece skippable: --skip-tmux / --skip-colors / --skip-firefox / --skip-code.
...
# scrolling + clipboard sync -- everything else is stock tmux, no custom mouse/copy bindings
set -g mouse on
